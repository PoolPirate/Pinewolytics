<script lang="ts">
	...
	function makeContractsChart(values: OptimismContractMetricsDTO[] | null, isWeeklyMode: boolean) {
		if (values == null) {
			return;
		}
	...
	function makeDevelopersChart(values: OptimismContractMetricsDTO[] | null, isWeeklyMode: boolean) {
		if (values == null) {
			return;
		}
